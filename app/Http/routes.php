...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	Route::get('properties', array('as' => 'admin_property_lists','uses'=>'PropertiesController@propertieslist'));
	...
	Route::group(['prefix' => 'properties'], function () {
	    Route::get('paypremium/{property_id}', ['as'=>'payPremium','uses'=>'PaypalController@payPremium']);
	    Route::post('getcheckout', ['as'=>'getCheckout','uses'=>'PaypalController@getCheckout']);
	    Route::get('getdone/{property_id}/{plan_id}', ['as'=>'getDone','uses'=>'PaypalController@getDone']);
	    Route::get('getcancel/{property_id}', ['as'=>'getCancel','uses'=>'PaypalController@getCancel']);
	});
